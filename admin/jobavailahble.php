	...
	<div class="wrapper d-flex align-items-stretch">
	        ...
	        <div class="footer">
	        	<p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This software was developed by Group 3 <i class="icon-heart" aria-hidden="true"></i> by Group 3<a href="https://colorlib.com" target="_blank">Colorlib.com</a>
	                                                 ...
	                                                 <td><?=$value['min']?></td>
													  <td><?=$value['max']?></td>
                                                        <td>
                                                          ...
                                                          <a  href="editjob.php?id=<?=$value['id']?>"class="btn btn-icon btn-primary " ><i class="fa fa-edit"></i></a> 
