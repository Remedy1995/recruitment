...
$sql = "SELECT * FROM `interview` WHERE 1";
...
<html>
<head><title>Interview List</title>
...
<div class="wrapper d-flex align-items-stretch">
	        ...
	        <ul class="list-unstyled components mb-5">
              ...
              <li>
              <a href="jobavailahble1.php"><span class="fa fa-sticky-note mr-3"></span>Applicant's C.V</a>
            </li>
			  <BR>
			  <BR>
			  <BR>
                                                    ...
                                                    <tr>
	                                                 ...
	                                                 <td><?=$value['gender']?></td>
													  ...
													  <td><?=$value['location']?></td> 
													   <td><?=$value['email']?></td>
                                                        <td>
<a  href="/kofi/back/interviewlist.php?id=<?=$value['id']?>" class="btn btn-icon btn-primary " ><i class="fa fa-arrow-right"></i></a>
  <a  href="details.php?id=<?=$value['email']?>" class="btn btn-icon btn-primary " ><i class="fa fa-list"></i></a> 
    <a  href="/kofi/back/delateint.php?id=<?=$value['id']?>" class="btn btn-icon btn-danger " ><i class="fa fa-trash-o"></i></a> 
 											</td>
                                                    </tr>
                                                <?php $i++; } ?>
                                                </tbody>
