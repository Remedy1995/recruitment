        ...
        <div class="four-grids">
          <div class="col-md-3 four-grid">
            <div class="four-grid1">
              ...
              <a href="interviewlist.php" >Interview list</a>
            </div>
          </div>
          <div class="col-md-3 four-grid">
            <div class="four-grid2">
              ...
              <a href="newApplicant.php" >Applicant List</a>
            </div>
          </div>
          <div class="col-md-3 four-grid">
            <div class="four-grid3">
              ...
              <div class="four-text">
                <h3>Accepted Lists</h3>
                <h4>9 New</h4>
                <p> <span class="inlinebar">1,3,4,5,3,5</span> </p>
              </div>
              <a href="aceptedlist.php">Accepted List</a>
            </div>
          </div>
          <div class="col-md-3 four-grid">
            <div class="four-grid4">
              ...
              <a href="jobavailahble.php">Job Available</a>
            </div>
          </div>
          <div class="clearfix"></div>
        </div>
