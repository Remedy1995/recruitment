...
$sql = "SELECT * FROM `acepted` WHERE 1";
...
<html>
<head><title>Accepted List</title>
	...
	<div class="wrapper d-flex align-items-stretch">
			<nav id="sidebar">
	          ...
	          <span class="sr-only">Toggle Menu</span>
				...
				<div class="p-4">
		  		<h1><a href="index.html" class="logo">Accepted List<span>ADMIN</span></a></h1>
	        <ul class="list-unstyled components mb-5">
                <li class="active">
	            <a href="dasboard.php"><span class="fa fa-home mr-3"></span> Home</a>
	          </li>
	          <li class="active">
	            <a href="interviewlist.php"><span class="fa fa-user mr-3"></span> Interview List</a>
	          </li>
	          <li>
	              <a href="newApplicant.php"><span class="fa fa-user mr-3"></span>New Applicant</a>
	          </li>
	          <li>
              <a href="aceptedlist.php"><span class="fa fa-user mr-3"></span>Accepted List</a>
	          </li>
	          <li>
              <a href="jobavailahble.php"><span class="fa fa-user mr-3"></span> Edit Jobs</a>
	          </li>
			  <BR>
			  <BR>
			  <BR>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="newApplicant.php">New Applicant</a>
      </li>
      <li class="nav-item">
                                                ...
                                                <tbody>
                                                    ...
                                                    <td><?=$value['fname']?></td>
	                                                 <td><?=$value['gender']?></td>
													  ...
													  <td><?=$value['email']?></td>
														<td>
                                                          <a  href="details.php?id=<?=$value['email']?>"  class="btn btn-icon btn-primary mr-1 mb-1"><i class="fa fa-list"></i></a> 
