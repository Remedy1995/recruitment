...
<meta name="keywords" content="Selection Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
...
<body class="cbp-spmenu-push">
  ...
  <div class="main-content">
    ...
    <!--left-fixed -navigation-->
    <!-- header-starts -->
    <div class="sticky-header header-section " style="background: rebeccapurple">
      <div class="header-left">
        <!--logo -->
        <div class="logo">
          <a href="index.html"><h1>Selection</h1></a>
        </div>
        <!--//logo-->
 ...
 <div class="four-grids">
          <div class="col-md-3 four-grid">
            <div class="four-grid1" style="background: blueviolet">
              
              
            <h1>  <a href="jobavailahble.php" >job Available</a><h1>
            </div>
          </div>
          <div class="col-md-3 four-grid">
            <div class="four-grid2">
             ...
             <h1> <a href="viewacdamicinfo.php" >View Academic info</a></h1>
            </div>
          </div>
          ...
          <div class="col-md-3 four-grid">
            <div class="four-grid4">
              ...
              <h1><a href="vpersonal.php">View  Personal info</a></h1>
            </div>
          </div>
          <div class="clearfix"></div>
        </div> 
  ...
  <!--<input type="button" id="addPanelButton" onclick="addPanel()" value="add panel">
    ...
    <div id="chartdiv"></div>
      ...
      <div class="copy-section" style="background: rebeccapurple;" >
    <p style="color: white">&copy; 2020 Group 3. All rights reserved | Design by Group 3</p>
    </div>
  </div>
      <!-- Classie -->
